...
func levelcomplete():
	if Global.level < 8 and Global.enemy_difficulty == 1 :
		Global.money += 30 
		Global.level = 8
	...
	if Global.level < 8 + 7*2 and Global.enemy_difficulty == 1.4:
		Global.money += 30 
		Global.level = 8 + 7 * 2
	if Global.level < 8 + 7*3 and Global.enemy_difficulty == 1.6:
		Global.money += 30 
		Global.level = 8 + 7*3
	if Global.level < 8 + 7*4 and Global.enemy_difficulty == 1.8:
		Global.money += 30 
		Global.level = 8 + 7*3
	else:
		Global.money += 10
