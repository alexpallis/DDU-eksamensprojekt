...
var speed = 50  # Speed of movement to the right
var steal_value = 100 # the amount the unit steals from the hous
var attack_cooldown = 3.0  # Time between attacks
var attack_damage = 100  # Default attack damage
var health = 1  # Unit health
var can_attack = true
