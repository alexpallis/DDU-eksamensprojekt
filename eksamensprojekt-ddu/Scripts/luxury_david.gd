...
var steal_value = 75 * Global.enemy_difficulty # the amount the unit steals from the hous
var attack_cooldown = 1.0   # Time between attacks
var attack_damage = 0 * Global.enemy_difficulty  # Default attack damage
var health = 20 * Global.enemy_difficulty  # Unit health
var can_attack = true
