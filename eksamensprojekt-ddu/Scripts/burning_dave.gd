...
var speed = 250 * (1 + (Global.D19-1)/10)
var steal_value = 10 * (1 + (Global.D19-1)/10)
var attack_cooldown = 0.75 
var attack_damage = 25 * (1 + (Global.D19-1)/10)
var health = 200 * (1 + (Global.D19-1)/10)
var can_attack = true
var price = 40
...
func _ready():
	...
	self.tooltip_text = ("Burning Dave" +
		"\n" + str(Global.D19) + " Level" + 
		"\n" + str(speed) + " Speed" +
		...
		"\n" + str(health) + " Health" +
		"\n" + str(price) + " Coins" +
		"\n It's dave but he is burning you shoud help him")
