...
var steal_value = 5 * Global.enemy_difficulty # the amount the unit steals from the hous
var attack_cooldown = 0.5  # Time between attacks
var attack_damage = 5 * Global.enemy_difficulty  # Default attack damage
var health = 50 * Global.enemy_difficulty  # Unit health
var can_attack = true
