...
var sf = 1 + (Global.D3 - 1) / 10.0

@export var speed = 200 * sf # Speed of movement to the right
@export var steal_value = 30 * sf # the amount the unit steals from the hous
@export var attack_cooldown = 1.0  # Time between attacks
@export var attack_damage = 10 * sf # Default attack damage
@export var health = 30 * sf # Unit health
var can_attack = true
