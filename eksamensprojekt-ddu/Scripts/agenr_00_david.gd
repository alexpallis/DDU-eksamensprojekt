...
var speed = 125 * Global.enemy_difficulty  # Speed of movement to the right
var steal_value = 20 * Global.enemy_difficulty # the amount the unit steals from the hous
var attack_cooldown = 0.4  # Time between attacks
var attack_damage = 10 * Global.enemy_difficulty # Default attack damage
var health = 125 * Global.enemy_difficulty # Unit health
var can_attack = true
